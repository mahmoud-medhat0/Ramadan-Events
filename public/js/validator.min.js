+(function(t) {
    ...
    function e(e) {
        return e.is('[type="checkbox"]') ?
            ...
            e.is("select[multiple]") ? (e.val() || []).length : e.val();
    }
    ...
    (a.VERSION = "0.11.8"), (a.INPUT_SELECTOR =
        ':input:not([type="hidden"], [type="submit"], [type="reset"], button)'), (a.FOCUS_OFFSET = 20), (a.DEFAULTS = {
        delay: 500,
        html: !1,
        disable: !0,
        focus: !0,
        ...
        var e = this;
        return (this.$inputs = this.$element
        ...
        function i() {
            ...
            return t.typeMismatch ?
                ...
                t.rangeUnderflow ?
                r.data("min-error") :
                t.valueMissing ? r.data("required-error") : null;
        }
        ...
        var n = [],
            l = t.Deferred();
        return r.data("bs.validator.deferred") &&
            r.data("bs.validator.deferred").reject(), r.data(
        ...
        if (this.options.focus) {
            ...
            0 !== e.length &&
                (
                    t("html, body").animate({ scrollTop: e.offset().top - a.FOCUS_OFFSET },
                        250
                    ),
                    e.focus()
                );
        ...
        a.length &&
            (
                (a = t("<ul/>").addClass("list-unstyled").append(
                    t.map(a, function(e) {
                        return t("<li/>")[r](e);
                    })
                )),
        ...
        a.html(a.data("bs.validator.originalContent")), r.removeClass(
                "has-error has-danger has-success"
        ...
        this.validate(), (this.isIncomplete() || this.hasErrors()) &&
            t.preventDefault();
        ...
        return (r = t.proxy(r, this, e)), this.options.delay ?
            (
        ...
        return this.$element
            ...
            .removeClass(this.options.feedback.success), this.$inputs
            ...
            }), this.$btn.removeClass("disabled"), this.$element
            .find(".has-error, .has-danger, .has-success")
            .removeClass("has-error has-danger has-success"), this;
    }), (a.prototype.destroy = function() {
        return this.reset(), this.$element
            .removeAttr("novalidate")
            .removeData("bs.validator")
            .off(".bs.validator"), this.$inputs.off(
                ".bs.validator"
            ), (this.options = null), (this.validators = null), (this.$element = null), (this.$btn = null), (this.$inputs = null), this;
    });
